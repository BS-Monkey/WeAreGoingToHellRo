    ...
    <Paper className={classes.root} variant="outlined">
      ...
      <div className={classes.postInfoWrapper}>
        ...
        {isReaded
          ...
          {flairSubmission !== 0 && (
            <Button variant="outlined" style={{height: '20px', marginLeft: '10px', borderRadius: 8}} size="small">{flairKind[flairSubmission].name}</Button>
          )}
        </Typography>
        {author 
          ? ban_state 
